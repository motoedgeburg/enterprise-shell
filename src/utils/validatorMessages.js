const validatorMessages = {
  ...
  VALIDATOR_PHONE:       { id: 'VALIDATOR_PHONE',       defaultMessage: 'Enter a valid US phone number, e.g. (215) 555-0100' },
  ...
  VALIDATOR_MIN_LENGTH:  { id: 'VALIDATOR_MIN_LENGTH',  defaultMessage: 'Must be at least {min} characters' },
  VALIDATOR_MAX_LENGTH:  { id: 'VALIDATOR_MAX_LENGTH',  defaultMessage: 'Cannot exceed {max} characters' },
};
