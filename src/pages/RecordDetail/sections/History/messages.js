const historyMessages = {
  ...
  DETAIL_TAB_CERTIFICATIONS: { id: 'DETAIL_TAB_CERTIFICATIONS', defaultMessage: 'Professional Certifications' },

  // ─── Emergency Contacts ────────────────────────────────────────────────────
  DETAIL_CONTACTS_COL_NAME:         { id: 'DETAIL_CONTACTS_COL_NAME',         defaultMessage: 'Name' },
  DETAIL_CONTACTS_COL_RELATIONSHIP: { id: 'DETAIL_CONTACTS_COL_RELATIONSHIP', defaultMessage: 'Relationship' },
  ...
  DETAIL_CONTACTS_ADD_TITLE:        { id: 'DETAIL_CONTACTS_ADD_TITLE',        defaultMessage: 'Add Emergency Contact' },
  DETAIL_CONTACTS_EDIT_TITLE:       { id: 'DETAIL_CONTACTS_EDIT_TITLE',       defaultMessage: 'Edit Emergency Contact' },
  DETAIL_CONTACTS_SET_PRIMARY:      { id: 'DETAIL_CONTACTS_SET_PRIMARY',      defaultMessage: 'Set as primary contact' },
  DETAIL_CONTACTS_DELETE_CONFIRM:   { id: 'DETAIL_CONTACTS_DELETE_CONFIRM',   defaultMessage: 'Remove this emergency contact?' },
  DETAIL_CONTACTS_EMPTY:            { id: 'DETAIL_CONTACTS_EMPTY',            defaultMessage: 'No emergency contacts on file.' },
  ...
  DETAIL_CERTS_DELETE_CONFIRM: { id: 'DETAIL_CERTS_DELETE_CONFIRM', defaultMessage: 'Remove this certification?' },
